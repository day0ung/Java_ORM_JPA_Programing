package com.inf.jpabasic.service.impl;

import com.inf.jpabasic.common.exceptions.DuplicateException;
...
public class UserServiceImpl implements UserService {
    ...
    public Optional<UserEntity> getUser(String email) {
        ...
        return Optional.ofNullable(userEntity); //optional을 사용하여 null일수도 있다는것
    }
